(function () {
    ...
    */
    ...
    !username ? username = "Desconhecido" : alert("Bem vindo, " + username);
    ...
    */
    ...
    $button.addEventListener("click", function (event) {
        ...
        var resUser = confirm("Tem certeza que deseja enviar o formulário? ");
        resUser ? alert("Enviado com sucesso!") : alert("Não enviado");
    }, false);
    ...
    Alguns e-mails inválidos:
        ...
        - "agua_@evida.br.com"
    */
    var emails = ["meu.email+categoria@gmail.com", "juca_malandro@bol.com.br", "pedrobala@hotmail.uy", "sandro@culinaria.dahora",
    "walter-da-silva@maraca.br","rita-marica@titica.a.b", "agua_@evida.br.com"
    ]
