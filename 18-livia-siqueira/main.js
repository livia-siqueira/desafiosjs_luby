(function () {
    ...
    */
    ...
    for (var i = 0; i < cpf.length; i++) {
        cpfClean[i] = cleanCPF(cpf[i]);
    }

    console.log("Limpos: ", cpfClean);
    ...
    */
    ...
    function formatedCPF(cpf) {
        ...
        return cpf.replace(regexCPF, function () {
            return arguments[1] + "." + arguments[2] + "." + arguments[3] + "-" + arguments[4];
        })
    }

    for (var i = 0; i < cpfClean.length; i++) {
        console.log(formatedCPF(cpfClean[i]));
    }
    ...
    */
    ...
    var regexMonth = /ju\w{3}/g;
    var matchMonth = str.match(regexMonth);
    ...
    */
    ...
    var regexTag = /<\w+>/g;
    var matchTag = tags.match(regexTag);
    console.log(tags + " \nresultado: " + matchTag);
    ...
    */
    ...
    var tagsClean = "<div><ul><li></li><li></li><li><span></span></li></ul></div>";
    var regexTagClean = /<\w+><\/\w+>/g;
    var matchTagClean = tagsClean.match(regexTagClean);
    console.log(matchTagClean);
