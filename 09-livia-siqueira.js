...
(function () {
    ...
    */
    var number1Function1and2 = 10;
    var number2Function1and2 = 20;

    function myFunction() {
        console.log('Na função `myFunction`, o primeiro número é', number1Function1and2);
        console.log('Na função `myFunction`, o segundo número é', number2Function1and2);
        return number1Function1and2 + number2Function1and2;
    }
    myFunction();
    ...
    */
    ...
    var sum = calculator(number1Function1and2, number2Function1and2); //variaveis reutilizadas das funções 1 e 2
    ...
    */
    ...
    var multiplication = calculator(67, 98);
    ...
    */
    ...
    console.log('O resultado da subtração é: '
        + subtraction(function (number1, number2) { return number1 - number2 }));


    console.log('O resultado da multiplicação é: '
        + multiplication(function (number1, number2) { return number1 * number2 }));


    console.log('O resultado da divisão é: '
        + division(function (number1, number2) { return number1 / number2 }));


    console.log('O resto da divisão é: '
        + mod(function (number1, number2) { return number1 % number2 }));
